...
<%
	...
	%>
					<div id="all_form">
				    	<div id="form_title">
				        	Επεξεργασία Δημοπρασίας! <%out.print(bids);%>
				        </div>
...
%>
				<div id="all_form">
			    	<div id="form_title">
			        	Επισκόπηση Δημοπρασίας!
			        </div>

			        <div id="main_form">

			            	<p><label>Όνομα : <%out.print(item_set.getString("name"));%>" </label></p>
			                <br/>
			                ...
			                <br/>
			                <br/>
			                <p><label>Προσφορές  :</label></p>
			                <table align="center" width="700" border="1">
								<tr>
								  <td>Όνομα Χρήστη</td>
								  <td>Τιμή Προσφοράς</td>
								  <td>Ημερομηνία Προσφοράς</td>
								</tr>
			                <%
			                ...
			                %>
								<tr>
								  <td><%out.print(bid_set.getString("username"));%></td>
								  <td><%out.print(bid_set.getFloat("price"));%></td>
								  <td><%out.print(bid_set.getString("date_time"));%></td>
								</tr>
							<%
							}
							%>
